    ...
    const MaktubEditor = {
        ...
        showGridOnly: function() {
            ...
            slugsToShow.forEach(slug => {
                ...
                if (cat) {
                    let visual = '';
                    if (cat.slug === 'pastel-salgado') {
                        visual = `<img src="https://pastelariamaktub.com.br/wp-content/uploads/2024/11/Cat-Pasteis-Salgados.webp" class="maktub-cat-thumb" alt="Pastel Salgado">`;
                    } else {
                        let icon = '🥟';
